...
def log_request_info():
    ...
    connection_type = "🔒 HTTPS" if (is_secure or protocol == 'https' or url_scheme == 'https') else "⚠️ HTTP"
    print(f"[{connection_type}] {request.method} {request.path} - Scheme: {protocol}, Secure: {is_secure}")
...
if __name__ == '__main__':
    ...
    if ssl_context:
        ...
        print("\n⚠️  IMPORTANT: Flask development server with SSL ONLY accepts HTTPS connections")
